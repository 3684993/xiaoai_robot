...
from .config_xiaoai_leader import XiaoaiLeaderConfig

logger = logging.getLogger(__name__)


class XiaoaiLeader(Teleoperator):
    """
    LeLamp Leader Arm designed by TheRobotStudio and Hugging Face.
    """

    config_class = XiaoaiLeaderConfig
    name = "xiaoai_leader"

    def __init__(self, config: XiaoaiLeaderConfig):
